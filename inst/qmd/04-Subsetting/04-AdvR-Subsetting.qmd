...
The default `drop = TRUE` can be a common source of bugs in functions. When writing functions, get in the habit of using `default = TRUE` or tibbles.
...
* `purrr::check`: Always throws an error
