...
![](https://bradleyboehmke.github.io/uc-bana-7025/images/new_project.png)
...
![](https://raw.githubusercontent.com/NEONScience/NEON-Data-Skills/main/graphics/r-skills/RStudio-GUI-setWD.png)
:::
::: 
...
- To figure out what it needs, you can use the help function **help(function_name)** or its shortcut
**?function_name**. You can also click the "Help" tab
- Here you will read about the package usage, descriptions arguments, details etc. 
![](https://intro2r.com/images/rs_help.png) 
...
Updated packages makes sure you are working with the latest versions which cna include fixes of old bugs
...
**OR**
Use: update.packages(ask=FALSE) or install.packages("package_name", dependencies = TRUE, update = TRUE)
