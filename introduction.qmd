...
execute:
  ...
  freeze: auto
---
# Downloading Materials from GitHub

Make sure you have the `devtools` package installed.

## Install the RLAB package
...
```{r}
RLAB::render_presentation(
  outdir = "where_you_want_this_stored",
  name = "01"
)
```

# What Are R and Positron?
...
# Updating Positron and Packages
